...
public class ShakeFeature implements SensorEventListener {

    // Minimum acceleration needed to count as a shake movement
    private static final int MIN_SHAKE_ACCELERATION = 12;
    ...
    public ShakeFeature(OnShakeListener shakeListener) {
